#ifndef THREAD_POOL_CPP17_HPP
#define THREAD_POOL_CPP17_HPP
...
public:
    ...
    [[nodiscard]] auto submit_r(F&& f, Args&&... args)
        -> TaskHandle<std::invoke_result_t<F, Args...>>
    {
    ...
    [[nodiscard]] size_t thread_count() const noexcept { return cur_threads_.load(); }
    [[nodiscard]] size_t min_threads()  const noexcept { return min_threads_; }
    [[nodiscard]] size_t max_threads()  const noexcept { return max_threads_; }
